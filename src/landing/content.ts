...
export const localizedCopy = {
  en: {
    ...
    receiptBenefits: ['A receipt made for your organization', 'A clear digital record for every offering', 'Beautiful templates for every occasion'],
  ...
  mr: {
    ...
    chat: 'व्हॉट्सअ‍ॅपवर बोला',
    demo: 'व्हॉट्सअ‍ॅपवर डेमो बुक करा',
    portal: 'पोर्टल लॉगिन',
    ...
    receiptBenefits: ['तुमच्या संस्थेसाठी योग्य पावती', 'प्रत्येक देणगीची स्पष्ट डिजिटल नोंद', 'प्रत्येक सणासाठी सुंदर टेम्पलेट्स'],
    ...
    formNotice: 'सबमिट केल्यानंतर आमच्या टीमसाठी तयार ईमेल विनंती तुमच्या ईमेल अ‍ॅपमध्ये उघडेल.',
...
export const supportingServices = {
  ...
  mr: [
    ['ई-पावती', 'डिजिटल वर्गणी पावत्या', 'परिचित वर्गणी पावती डिजिटल करा आणि प्रत्येक देणगीदाराला व्हॉट्सअ‍ॅपवर त्याच ब्रँडची पावती पाठवा.'],
