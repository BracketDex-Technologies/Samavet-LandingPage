...
export const localizedCopy = {
  en: {
    ...
    chat: 'Start on WhatsApp',
    demo: 'Request a demo',
    portal: 'Portal login',
    nav: ['ePawati', 'Event intelligence', 'Services', 'For communities', 'Contact'],
    heroEyebrow: 'A clearer way to hold every offering',
    heroTitle: ['Digital receipts for', 'every community offering.'],
    heroDescription: 'ePawati helps community organizations issue digital donation receipts and keep activity easier to understand.',
    heroSignals: ['Digital donation receipts', 'Event intelligence', 'Community-first support'],
  ...
  mr: {
    ...
    heroEyebrow: 'प्रत्येक देणगीसाठी स्पष्ट पद्धत',
    heroTitle: ['प्रत्येक समुदाय देणगीसाठी', 'डिजिटल पावती.'],
    heroDescription: 'ई-पावतीमुळे समुदाय संस्था डिजिटल देणगी पावत्या तयार करू शकतात आणि उपक्रमांचा स्पष्ट आढावा घेऊ शकतात.',
    heroSignals: ['डिजिटल देणगी पावत्या', 'इव्हेंट इंटेलिजन्स', 'समुदाय-केंद्रित मदत'],
